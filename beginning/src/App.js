...
const DUMMY_EXPENSES=[
  {expenseDate:new Date(2019,1,11),expenseTitle:"Car Insurance",expenseAmount:"294.67"},
  {expenseDate:new Date(2020,2,22),expenseTitle:"Mobile purchase",expenseAmount:"195"},
